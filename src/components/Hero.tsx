      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <motion.a
              href="#projects"
              className="px-8 py-4 bg-gradient-primary text-primary-foreground rounded-full font-body font-medium flex items-center gap-2"
              whileHover={{ scale: 1.05, boxShadow: "0 0 30px hsl(175 80% 50% / 0.4)" }}
              whileTap={{ scale: 0.95 }}
            >
              View My Work
              <ArrowDown size={18} />
            ...
            <motion.a
              href="#contact"
              className="px-8 py-4 border border-border text-foreground rounded-full font-body font-medium hover:bg-secondary transition-colors"
